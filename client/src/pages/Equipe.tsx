  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      quote: "L'innovation est le moteur du progrès. Notre mission est de rendre cette innovation accessible à tous.",
      ...
      skills: ['Vision Stratégique', 'Leadership', 'IA & Big Data', 'Gestion de l\'Innovation']
    },
    {
      id: 2,
      name: 'Sophia Chen',
      ...
      quote: "La technologie doit servir l'humain, pas l'inverse. C'est cette philosophie qui guide chacune de nos solutions.",
      ...
      skills: ['IA & Machine Learning', 'Architecture Système', 'Automatisation', 'Développement Cloud']
    },
    {
      id: 3,
      name: 'Marc Lefevre',
      ...
      skills: ['Développement Commercial', 'Gestion de la Relation Client', 'Stratégie de Vente', 'Négociation']
    },
    {
      id: 4,
      name: 'Amina Diallo',
      ...
      quote: "L'automatisation intelligente est la clé pour libérer le potentiel humain dans chaque organisation.",
      image: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?q=80&w=1972&auto=format&fit=crop&ixlib=rb-4.0.3',
      socialLinks: {
        linkedin: 'https://linkedin.com/',
        github: 'https://github.com/',
        email: 'mailto:amina@udi-business.com'
      },
      skills: ['Automatisation des Processus', 'WhatsApp Business API', 'LinkedIn Automation', 'Chatbots IA']
    },
    {
      id: 5,
      name: 'Paul Mercier',
      ...
      skills: ['Développement Full-Stack', 'Architecture Logicielle', 'DevOps', 'Cloud Native']
    },
    {
      id: 6,
      name: 'Sarah Bouaziz',
      ...
      skills: ['Machine Learning', 'NLP', 'Analyse Prédictive', 'Vision par Ordinateur']
    }
  ];
      ...
      <div ref={containerRef} className="min-h-screen bg-gray-900 text-white">
        ...
        >
          <div ref={headerRef} className="max-w-3xl mx-auto text-center mt-8">
            <p className="animate-item text-lg text-gray-300 mb-6">
              Découvrez les talents passionnés qui font d'UDI-BUSINESS le leader de l'innovation digitale et de l'automatisation multiplateforme.
            </p>
            <div className="animate-item flex justify-center space-x-2">
              <span className="px-3 py-1 bg-[#0080FF]/20 rounded-full text-[#0080FF] text-sm">Innovation</span>
              <span className="px-3 py-1 bg-[#FFC000]/20 rounded-full text-[#FFC000] text-sm">Expertise</span>
              <span className="px-3 py-1 bg-purple-500/20 rounded-full text-purple-400 text-sm">Passion</span>
            </div>
          </div>
        </AnimatedPageHeader>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mb-20 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 text-gradient">Notre vision collective</h2>
            <div className="relative py-8 px-6 bg-gray-800/50 rounded-xl border border-gray-700/50 shadow-xl">
              <FontAwesomeIcon icon={faQuoteLeft} className="absolute top-4 left-4 text-[#0080FF]/30 text-4xl" />
              <p className="text-xl text-gray-300 italic">
                Notre équipe est guidée par une vision commune : façonner l'avenir digital des entreprises à travers des solutions innovantes, évolutives et centrées sur l'humain. Nous croyons que la technologie doit être un facilitateur, jamais une barrière.
              </p>
              <FontAwesomeIcon icon={faQuoteRight} className="absolute bottom-4 right-4 text-[#FFC000]/30 text-4xl" />
            </div>
          </div>

          {/* Cartes des membres de l'équipe */}
          <div ref={teamRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="mt-24 py-16 px-8 rounded-2xl bg-gradient-to-r from-[#0080FF]/20 to-[#FFC000]/20 border border-gray-700/30 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Vous êtes passionné(e) par l'innovation et souhaitez contribuer à la transformation digitale des entreprises? UDI-BUSINESS recherche constamment de nouveaux talents.
              </p>
              <a 
                href="#contact" 
