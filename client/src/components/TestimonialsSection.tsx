...
const TestimonialsSection = () => {
  ...
  if (isLoading) {
    return (
      <section id="testimonials" className="py-24 bg-gray-800 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 relative animate-pulse">
    ...
    <section id="testimonials" className="py-24 bg-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div id="testimonials-heading" className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Ce que nos <span className="text-gradient">clients</span> disent</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className={`absolute -top-5 -left-5 text-6xl text-[${index % 2 === 0 ? '#0080FF' : '#FFC000'}] opacity-30`}>"</div>
