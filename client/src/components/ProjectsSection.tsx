...
const ProjectsSection = () => {
  ...
  const categories = ['Tous', 'Développement', 'Intelligence Artificielle', 'Automatisation', 'Conseil'];
      ...
      <section id="projects" className="py-24 bg-gray-800 relative">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="mb-10 flex flex-wrap justify-center gap-4 animate-pulse">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="px-6 py-2 rounded-full bg-gray-700 w-28 h-10"></div>
            ))}
          </div>
  ...
  return (
    <section id="projects" className="py-24 bg-gray-800 relative">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div id="project-categories" className="mb-10 flex flex-wrap justify-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="project-card bg-gray-900 rounded-xl overflow-hidden group relative">
