      ...
      <section id="services" className="py-24 bg-gray-900 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 relative overflow-hidden animate-pulse">
    ...
    <section id="services" className="py-24 bg-gray-900 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div id="services-heading" className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Nos <span className="text-gradient">Services</span></h2>
                  ...
                  <div className="md:w-3/4 md:pl-6">
                    <h3 className="text-2xl font-bold mb-3 text-[#FFC000] text-center md:text-left">
                      ...
                      <span className="block text-sm font-normal text-gray-400 mt-1">
                        Notre expertise principale - L'intelligence artificielle au service de votre croissance
                      </span>
                    </h3>
          ...
          {services
            ...
            .map(service => (
              ...
              >
                ...
                <a 
                  href={
                    service.title.includes('Développement') ? "/ServiceSoftwareDev" : 
                    service.title.includes('IA') ? "/ServiceAIBigData" : 
                    service.title.includes('Conseil') ? "/ServiceDigitalConsulting" : "#"
                  }
      ...
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-[#FFC000]/10 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
    </section>
  );
};
